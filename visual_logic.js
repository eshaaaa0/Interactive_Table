...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectByName, getSceneAnimFrameRate, getSceneByAction,
    };
};
...
registerOnClick('slab3', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood ', 'wood.jpg', 'wood_basecolor_1.jpg', false, function() {});
}, function(event) {});
registerOnClick('slab1', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood ', 'wood.jpg', 'wood_basecolor_2.jpg', false, function() {});
}, function(event) {});
registerOnClick('slab2', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood ', 'wood.jpg', 'wood_basecolor_3.jpg', false, function() {});
}, function(event) {});
registerOnClick('Sphere.001', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'chrome', undefined);
}, function(event) {});
registerOnClick('Sphere.001', false, false, [0,1,2], false, function(event) {
    assignMat('support_bush', 'chrome', undefined);
}, function(event) {});
registerOnClick('Sphere.002', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'chrome2', undefined);
}, function(event) {});
registerOnClick('Sphere.002', false, false, [0,1,2], false, function(event) {
    assignMat('support_bush', 'chrome2', undefined);
}, function(event) {});
registerOnClick('Sphere.003', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'chrome3', undefined);
}, function(event) {});
registerOnClick('Sphere.003', false, false, [0,1,2], false, function(event) {
    assignMat('support_bush', 'chrome3', undefined);
}, function(event) {});
